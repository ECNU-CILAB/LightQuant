...
parser.add_argument('--model_save_folder', default=f'/home/users/liuyu/Framework/result/{args.dataset}/model_saved/') # 模型保存位置
parser.add_argument('--figure_save_folder', default=f'/home/users/liuyu/Framework/result/{args.dataset}/figure/')
parser.add_argument('--test_result_save_folder', default=f'/home/users/liuyu/Framework/result/{args.dataset}/test_result/')
